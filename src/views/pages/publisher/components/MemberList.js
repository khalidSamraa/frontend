...
import { loadInterests } from "../../../../redux/actions/InterestsAction.js";
  ...
  renderMenu() {
    ...
    return (
      <div className="dropdown-content">
        ...
        {/*<a tabIndex="0" role="button" onClick={()=>this.props.toggle()}>{words.publisher_add_member}</a>*/}
        <a tabIndex="0" role="button" onClick={() => this.toggleAddMember()}>{words.publisher_add_member}</a>
      </div>
    )
  }
          ...
          <div className="col-xs-12">
            <div className="box">
              ...
              <ul className={classnames("member-list scrolled-item w99", { "hide": this.props.show })} onScroll={this.handleScroll}>
                <Animated total={5} loading={isLoading} count={count} text={words.publisher_member_empty} animation={<UserList />}>
