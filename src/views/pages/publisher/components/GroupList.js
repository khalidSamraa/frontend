...
export default class GroupList extends React.Component {
  ...
  toggleAddGroup = () => {
    this.setState({
      toggleAddGroup: !this.state.toggleAddGroup,
      in_update: true
    })
    this.onRegister()
  }
  ...
  renderMenu() {
    ...
    return (
      <div className="dropdown-content" style={{ "right": "20px" }}>
        ...
        <a tabIndex="0" id="add_group" role="button" onClick={() => this.toggleAddGroup()}>{words.publisher_add_group}</a>
      </div>
    )
  }
    ...
    return (
      <div className="animated fadeIn">
        <div className="gi-header">
          <div className="gi-title cursor">{words.publisher_groups}</div>
          ...
          <a className='btn black small' tabIndex="0" id="add_group" role="button" onClick={() => this.toggleAddGroup()}>{words.publisher_add_group}</a>
        </div>
          ...
          <div className="col-xs-12">
            <div className="box">
              <UserSearch
                ...
                placeholder={words.publisher_field_group_name}
