...
class AddMemberGroupRow extends React.Component {
  ...
  renderMenu(rowData) {
    ...
    return (
      ...
      <div className="dropdown-content">
        ...
        <a tabIndex="0" role="button" className="red-i" onClick={()=>this.props.removeMember(rowData.uid)}>{words.ensemble_delete_member}</a>
      </div>
    </DropDownDynamic>
    )
  }
  ...
  render() {
    const {rowData, mode, groupID, words} = this.props
