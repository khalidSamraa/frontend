  ...
  renderMenu() {
    ...
    return (
      <div className="dropdown-content">
        ...
        <a tabIndex="0" role="button" onClick={() => this.props.setMode("add")}>{words.institution_add_member}</a>
      </div>
    )
  }
    ...
    return (
      <div className={classnames("hide", { "show": show })}>
        <div className="gi-header">
          <div className="gi-title">{words.institution_members}</div>
        ...
        {mode === "add" ?
          <div className="add-member-to-group">
            {/*<span>{words.institution_add_member_to_group} <a className="gname">{groupName}</a></span> */}
            <span>{words.institution_add_member_to_group}</span>
