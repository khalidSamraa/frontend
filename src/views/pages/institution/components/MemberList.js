  ...
  renderMenu() {
    ...
    return (
      <div className="dropdown-content">
        ...
        {/*<a tabIndex="0" role="button" onClick={()=>this.props.toggle()}>{words.institution_add_member}</a>*/}
        <a tabIndex="0" role="button" onClick={() => this.toggleAddMember()}>{words.institution_add_member}</a>
      </div>
    )
  }
