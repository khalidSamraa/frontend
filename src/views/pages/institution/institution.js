...
class Institution extends Component {
  ...
  onRemoveInstitutionSuccess = (response) => {
    ...
    this.props.history.push("/manage-institution")
  }
  ...
  */
  ...
  render() {
    ...
    const { words } = this.props.ActiveLanguageReducer
    const { institutionName, isUpdateInstitution, disabledUpdate } = this.state
          ...
          <div className="container">
            <div className="row">
              ...
              {/*<div className="col-md-2 col-sm-2 col-xs-2 center-content">
                <div>
                  <Options items={[{text: words.institution_delete, onClick: this.onRemoveInstitution, className: "red-i"}]} iconClassName={"md-icon"} />
                </div>
              </div>*/}
            </div>
            <div className="row">
